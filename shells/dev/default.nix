  ...
  utils = {
    shellHook = ''
      ...
      print_services_help() {
        ...
        echo "    nix develop .#rabbitmq"
        echo "    nix develop .#database (postgres + redis)"
        echo ""
        echo "  Run using github file:"
        echo "    nix develop github:yosephbernandus/nixology#postgres"
        echo "    nix develop github:yosephbernandus/nixology#redis"
        echo "    nix develop github:yosephbernandus/nixology#rabbitmq"
        echo "    nix develop github:yosephbernandus/nixology#database (postgres + redis)"
        echo ""
